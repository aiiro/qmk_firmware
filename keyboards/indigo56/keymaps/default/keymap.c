...
KC_TAB,     KC_F11,     KC_F12,     _______,    _______,    _______,        _______,    _______,    _______,    _______,     _______,    _______,\
KC_LCTL,    _______,    _______,    _______,    _______,    _______,        KC_LEFT,    KC_DOWN,    KC_UP,      KC_RIGHT,    KC_SCLN,    KC_QUOT,\
KC_LSFT,    _______,    _______,    _______,    _______,    _______,        _______,    _______,    _______,    _______,     _______,    KC_GRV,\
                        KC_LALT,    KC_LGUI,    LOWER,      KC_SPC,         KC_ENT,     RAISE,      KC_RGUI,    KC_RALT \
    ),
